...
function getHeaders(ctx: NextPageContextApp): object | null {
 ...
 */
const initApolloClient = (initialState: NormalizedCacheObject, headers: object) => {
...
const withApollo = ({ ssr = true } = {}) => (PageComponent: NextPage): ReactNode => {
    const WithApollo = ({
        ...
        if (apolloClient) {
            ...
            client = initApolloClient(apolloState, {} as NextPageContext);
        }
